...
const USER_LK_URL = isDev ? 'http://localhost:4200' : 'https://lk.karga.belivr.tech';
            ...
            <header  id="headid" className={cn({
                ...
                <div className={style.navmenu}>
                    ...
                    <ul ref={refUl} className={style.navmenu__list}>
                        ...
                        <Link onClick={handelActiveLink} className={style.list__item} href={USER_LK_URL}><li>Account</li></Link>
